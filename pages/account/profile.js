...
export default function UserProfile() {
  ...
  const submitHandler = async (e) => {
    ...
    const res = await fetch(`${API_URL}/api/user`, {
      ...
      method: "PUT",
      body: JSON.stringify({ email:userEmail, password, name: userName,id:user._id }),
    })
    ...
    <Layout title="User Register">
      ...
      {Object.keys(user).length ? (
        ...
        <form className={styles.form} onSubmit={submitHandler}>
          <h2>
              <FaUser className={ styles.icon}/> {user.isAdmin?(<pre>Admin</pre>):null}
          </h2>
          ...
          <div className={styles.input_wrapper}>
            ...
            <div className={styles.custom_checkbox}>
              ...
              <GiCheckMark className={ styles.icon + ' ' +(isChangePassword?styles.visible:'')}/>
            <input
              type="checkbox"
